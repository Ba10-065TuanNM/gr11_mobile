...
import  com.technifysoft.bookapp.databinding.ActivityPdfAddBinding;
...
//            all data is valid,can uo load now
            uploadPdfToStorage();
        }
...
//        step3: Upload PDF info to firebase db
        Log.d(TAG, "uploadPdfInfoToStorage: uploading PDF info to firebase db...");
...
} //add firebase storage to our project ( trong build grade )
